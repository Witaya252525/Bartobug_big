...
(() => {
  ...
  function renderDataInputs() {
    ...
    months.forEach((m, idx) => {
      ...
      const incomeInput = el("input", {
        ...
        inputMode: "numeric",
        placeholder: "Income",
        value: randomAmount(2000, 8000),
      });
      const incomeFeedback = el(
        "div",
      ...
      const expenseInput = el("input", {
        ...
        inputMode: "numeric",
        placeholder: "Expense",
        value: randomAmount(1500, 6000),
      });
      const expenseFeedback = el(
        "div",
        { class: "invalid-feedback" },
        "Enter a non-negative number",
      );
  ...
  function validateInputs() {
    ...
    if (!valid) {
      if (alert) {
        ...
        alert.textContent =
          "Please fix invalid inputs (must be non-negative numbers).";
      }
    } else {
      if (alert) {
  ...
  function wireDownloadButton() {
    const downloadBtn = qs("#download-chart");
